...
export function CreateStudent() {
  ...
  return (
    <DashboardShell user={user} title="Um novo aluno começa aqui." description="Cadastre o aluno e vincule-o a uma turma da sua escola." navigation={[{ label: "Turmas", href: "/coordenador/turmas", icon: "book" }, { label: "Alunos", href: "/coordenador#students", icon: "users" }, { label: "Professores", href: "/coordenador/professores", icon: "school" }]}>
